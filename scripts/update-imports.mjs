...
const REPLACEMENTS = [
    ...
    ['workflow/handlers/coleta.js', 'workflow/handlers/coleta.ts'],
    ['workflow/handlers/report.js', 'workflow/handlers/report.ts'],
    ['workflow/handlers/unspsc.js', 'workflow/handlers/unspsc.ts'],
    ['workflow/handlers/ncm.js', 'workflow/handlers/ncm.ts'],
    ['reporting/metadata.js', 'reporting/metadata.ts'],
    ['reporting/session.js', 'reporting/session.ts'],
    ['reporting/transport.js', 'reporting/transport.ts'],
    ['reporting/envio-relatorio.js', 'reporting/envio-relatorio.ts'],
    ['reporting/coletor-midia.js', 'reporting/coletor-midia.ts'],
    ['reporting/coletor-acompanhamento.js', 'reporting/coletor-acompanhamento.ts'],
    ['parsers/historico-parser.js', 'parsers/historico-parser.ts'],
    ['parsers/midia-parser.js', 'parsers/midia-parser.ts'],
    ['ui/relatorio-erros.js', 'ui/relatorio-erros.ts'],
